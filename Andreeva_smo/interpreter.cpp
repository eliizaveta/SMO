...
Andreeva_smo::Interpreter::Archive::Archive() { }

Andreeva_smo::Interpreter::Archive::Archive(std::vector<std::string> buffers, std::vector<std::string> devices,
...
void Andreeva_smo::Interpreter::newRequestGenerate(Andreeva_smo::Request request) {
    interpretation.push_back(std::make_pair(std::make_pair(request, -1), NEW_REQ));
}

void Andreeva_smo::Interpreter::addRequestToBuff(Andreeva_smo::Request request, int buff) {
    interpretation.push_back(std::make_pair(std::make_pair(request, buff), ADD_TO_BUFF));
}

void Andreeva_smo::Interpreter::deleteRequestFromBuff(Andreeva_smo::Request request, int buff) {
    interpretation.push_back(std::make_pair(std::make_pair(request, buff), DELETE_FROM_BUFF));
}

void Andreeva_smo::Interpreter::getRequestFromBuff(Andreeva_smo::Request request, int buff) {
    interpretation.push_back(std::make_pair(std::make_pair(request, buff), GET_FROM_BUFF));
}

void Andreeva_smo::Interpreter::addRequestToDevice(Andreeva_smo::Request request, int device) {
    interpretation.push_back(std::make_pair(std::make_pair(request, device), ADD_TO_DEVICE));
}

void Andreeva_smo::Interpreter::deleteRequestFromDevice(Andreeva_smo::Request request, int device) {
    interpretation.push_back(std::make_pair(std::make_pair(request, device), DELETE_FROM_DEVICE));
}

void Andreeva_smo::Interpreter::init() {
...
bool Andreeva_smo::Interpreter::config(int sourcesAmount, int buffersAmount, int devicesAmount) {
...
void Andreeva_smo::Interpreter::commit(float allWorkTime) {
...
std::vector<Andreeva_smo::Interpreter::Archive> Andreeva_smo::Interpreter::getSteps() { return steps; }

int Andreeva_smo::Interpreter::getLinesAmount() { return sourcesAmount + buffersAmount + devicesAmount; }

int Andreeva_smo::Interpreter::getDevicesAmount() { return devicesAmount; }

int Andreeva_smo::Interpreter::getBuffersAmount() { return buffersAmount; }

int Andreeva_smo::Interpreter::getSourcesAmount() { return sourcesAmount; }

std::vector<float> Andreeva_smo::Interpreter::getDeviceLoad() { return deviceLoad; }

std::vector<float> Andreeva_smo::Interpreter::getPFailure() { return pFailure; }

std::vector<float> Andreeva_smo::Interpreter::getDispTOP() { return dispTOP; }

std::vector<float> Andreeva_smo::Interpreter::getDispTOW()  { return dispTOW; }

std::vector<float> Andreeva_smo::Interpreter::getProcessTime() { return processTime; }

std::vector<float> Andreeva_smo::Interpreter::getWaitTime() { return waitTime; }

std::vector<float> Andreeva_smo::Interpreter::getTimeInSystem() { return timeInSystem; }

std::vector<int> Andreeva_smo::Interpreter::getDeniedReq() { return deniedReq; }

std::vector<int> Andreeva_smo::Interpreter::getProcessedReq() { return processedReq; }
